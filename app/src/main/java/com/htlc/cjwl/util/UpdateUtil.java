...
public class UpdateUtil {
    ...
    public void canUpdate(final boolean flag) {
        App.appAction.checkUpdate(new ActionCallbackListener<AppVersionBean>() {
            @Override
...
//        neutralButton.setTextColor(CommonUtil.getResourceColor(R.color.blue));
    }
    ...
    private void downloadApk(AppVersionBean appVersionBean) {
        ...
        downloadDialog.show();
        App.appAction.downloadApk(url, activity.getString(R.string.app_name) + newVersionName+".apk", new ResultCallback<String>() {
            @Override
