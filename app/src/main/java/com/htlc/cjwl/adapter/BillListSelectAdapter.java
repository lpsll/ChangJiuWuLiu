 ...
 */
public class BillListSelectAdapter extends BaseAdapter{

    private int id;
    private ArrayList<BillOrderBean> ordersList;
    private Context context;

    public BillListSelectAdapter(int id, ArrayList<BillOrderBean> ordersList, Context context) {
        this.id = id;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        BillOrderBean bean = ordersList.get(position);
